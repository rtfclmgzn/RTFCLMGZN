...
window.RTFC_ENTITIES = {
  ...
  models: [
    ...
    { re:/\bClaude Fable 5\b|\bFable 5\b/i, name:"Claude Fable 5", maker:"Anthropic", makerKey:"anthropic",
      kind:"frontier reasoning model", access:"closed" },
    { re:/\bClaude Opus 5\.5\b/i, name:"Claude Opus 5.5", maker:"Anthropic", makerKey:"anthropic",
      kind:"frontier reasoning model, current #1 on the independent Intelligence Index", access:"closed" },
    ...
    { re:/\bDeepSeek[- ]V4\.1[- ]Flash\b/i, name:"DeepSeek V4.1 Flash", maker:"DeepSeek", makerKey:"deepseek",
      kind:"open-weights model", access:"open-weights" },
    ...
    { re:/\bDeepSeek V4\b/i, name:"DeepSeek V4", maker:"DeepSeek", makerKey:"deepseek",
      kind:"open-weights model", access:"open-weights" },
    { re:/\bQwen3\.8-Max(?:-Preview|-0902)?\b/i, name:"Qwen3.8-Max", maker:"Alibaba", makerKey:"alibaba",
      kind:"frontier model", access:"partial" },
    { re:/\bQwen3\.8-Max-0902\b/i, name:"Qwen3.8-Max-0902", maker:"Alibaba", makerKey:"alibaba",
      kind:"frontier model", access:"partial" },
    ...
    { re:/\bQwen3\.8-Flash(?:-Next)?\b/i, name:"Qwen3.8-Flash-Next", maker:"Alibaba", makerKey:"alibaba",
      kind:"open-weights model", access:"open-weights" },
    { re:/\bQwen3\.8-Omni-Flash\b/i, name:"Qwen3.8-Omni-Flash", maker:"Alibaba", makerKey:"alibaba",
      kind:"omni-modal model", access:"closed" },
