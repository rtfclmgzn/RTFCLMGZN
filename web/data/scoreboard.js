...
window.RTFC_SCOREBOARD = {
  ...
  rows: [
    ...
    { model:"Kimi K3",            mode:"max",           lab:"Moonshot",  score:57, pin:3,    pout:15, status:"released",
      note:"Now independently scored by Artificial Analysis at 57 — #3 overall, narrowly ahead of Claude Opus 4.8 and every other open-weight model measured, including DeepSeek V4 Pro. The White House has separately alleged the model was built in part on distilled Anthropic outputs; that dispute is about provenance and is unresolved, and is separate from this independently measured capability score. Full open weights remain promised for July 27." },
