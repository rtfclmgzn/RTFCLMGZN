...
window.RTFC_SCOREBOARD = {
  ...
  scannedAt: "2026-07-26T07:20:00Z",
  basisNote: "Strength is the current Artificial Analysis Intelligence Index for a representative high-capability reasoning mode. Prices are vendor list prices stored separately from the independent score. This snapshot was cross-checked against the live Artificial Analysis model leaderboard; SWE-bench and Terminal-Bench remain supporting coding signals rather than being blended by hand into an opaque house score. Scanned July 16 2026 on the publication of Kimi K3, which is listed as released-but-unmeasured pending an independent aggregate. Re-scanned July 24 2026 alongside coverage of DeepSeek retiring its legacy API aliases in favor of V4: no change to the DeepSeek V4 Pro row — DeepSeek's own SWE-bench/MCPAtlas figures are vendor-reported, not the independent index, and this cycle's pricing research turned up conflicting secondary-source numbers rather than one verifiable vendor list price, so pin/pout stay null pending normalization. Re-scanned July 26 2026 to close a gap: Claude Opus 5 (launched July 24) and Alibaba's Qwen3.8-Max-Preview had both been covered by this newsroom without appearing here at all. Both are now listed as released-but-unmeasured — Opus 5 carries its published $5/$25 list price, Qwen3.8-Max carries none because Alibaba published none, and neither carries a score, because the only figures either vendor released are self-reported rather than the independent index this column tracks.",
  rows: [
