...
window.RTFC_MAGAZINE_ISSUES.push({
  ...
  },
  {
    ...
    "body": [
      "A snapshot of mid-2026 — not sci-fi, just shipping capability. They **write** at professional level and explain anything with infinite patience. They **see**: photograph a plant rash, a dashboard light, a confusing bill, and ask. They **listen and speak** well enough to interpret a live conversation. They **create**: describe a scene, a style, or a product shot, and get back an original image or a short video — no camera, no editing software. And they **act**: given tools, agents research across dozens of sources or complete multi-step tasks while you do something else — ask one to plan a trip and it can compare flights, check your calendar, and draft the itinerary without being walked through each individual step — or point one at a cluttered inbox and it can sort what's urgent and draft replies in your own voice. A well-built one still stops and asks before it actually books the flight or sends the email — the checkpoint is a design choice, not a limit of the technology.",
      "The boundary matters just as much. They still ==confidently make things up==. The same generation ability cuts the other way, too: tools convincing enough to write in your voice or draw your face are exactly convincing enough to fake someone else's — a **deepfake** video or cloned voice is now a phone-camera-quality problem, not a Hollywood one — convincing enough to fool a relative on an unexpected phone call, not just an audience in a theater ([our guide walks through how to check one](/article/check-whether-a-video-is-ai-generated)). They don't truly remember you between conversations unless built to. And nobody — including their makers — can fully explain any single answer.",
    ...
    "cards": [
      {
        ...
        "c": "#7ee0b8",
        "d": "Maker of ChatGPT and the GPT models — the current family is GPT-5.6 (nicknamed Sol, Terra and Luna). Backed by Microsoft's billions. The household name with the biggest audience on earth, and the default many people mean when they say 'AI.' Who owns it: a capped-profit company under a nonprofit foundation's board, with Microsoft as its largest outside backer."
      },
      {
        "n": "Anthropic",
        "tag": "THE CAREFUL ONE",
        "c": "#8b7cf7",
        "d": "Founded by OpenAI alumni who wanted safety at the centre. Maker of Claude (families named Fable, Opus, Sonnet and Haiku), beloved by writers and programmers for careful, thoughtful work. Full disclosure: Claude models write this very publication. Who owns it: a public benefit corporation with no controlling parent; Google and Amazon are both large outside investors."
      },
      {
        "n": "Google DeepMind",
        "tag": "THE RESEARCH EMPIRE",
        "c": "#6cb6f0",
        "d": "The lab with the deepest scientific bench — its research invented the transformer that powers everyone. Maker of the Gemini models, woven into Search, Gmail and Android, plus the image models that illustrated this magazine. Who owns it: a research division fully owned by Alphabet, Google's parent company."
      }
    ]
  },
  {
    ...
    "cards": [
      {
        ...
        "c": "#5fa8e8",
        "d": "Facebook's parent spent years giving its Llama models away free — seeding an entire ecosystem of open AI. Its newest models (the Muse line) now carry price tags for the first time, a strategy shift the industry is watching closely. Who owns it: Meta itself -- a publicly traded company (Nasdaq: META) with no separate corporate structure for its AI lab."
      },
      {
        "n": "xAI",
        "tag": "THE AGGRESSOR",
        "c": "#e0564d",
        "d": "Elon Musk's lab, maker of Grok, wired directly into X. Competes on speed and shockingly low prices — its latest model costs a fraction of rivals' rates. Moves fast, courts controversy, ships constantly. Who owns it: a private company controlled by Elon Musk, with no public shareholders."
      },
      {
        "n": "DeepSeek",
        "tag": "THE DISRUPTOR",
    ...
    "outro": "Supporting cast worth knowing: Mistral (Europe's champion — an independent French startup, no Big Tech parent), NVIDIA (the chip maker whose hardware nearly all of the above runs on — arguably the most powerful company in the story, and a standalone public company in its own right), and Hugging Face (the town square where open models live — also independent, though it partners with nearly everyone on this page)."
  },
  {
    "kind": "faceoff",
