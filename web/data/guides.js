...
window.RTFC_GUIDES = [
  {
    ...
    tldr:[
      ...
      "Give a role, state one job, add the facts only you know.",
      "Set constraints — length, format, what to avoid. Constraints aim the model.",
      "End by asking the model what it needs to know before drafting.",
      "Never accept the first draft: three quick reactions beat one perfect prompt."
    ],
    body:[
  ...
  },
  {
    ...
    tldr:[
      ...
      "For anything important, ask a second model and verify wherever they disagree."
    ],
    body:[
  ...
  },
  {
    ...
    tldr:[
      ...
      "Model tiers differ 5–25x in price; most people order too expensively out of habit.",
      "The routine 90% runs fine on cheap tiers; escalate only the hard 10%.",
      "Habit: draft cheap, escalate hard — that intuition outlasts every leaderboard."
    ],
    body:[
