...
Follow the exact same standards as a regular cycle (see `newsroom/runner/cycle-runbook.md` §1, §3, §4 for the house specs, JSON shape, and image-selection rules — read them in full before writing). In particular:
