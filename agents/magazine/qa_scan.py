...
for f in glob.glob(os.path.join(WEB, "data", "*issue*.js")) + glob.glob(os.path.join(WEB, "data", "primer*.js")):
...
for f in glob.glob(os.path.join(WEB, "data", "*issue*.js")) + glob.glob(os.path.join(WEB, "data", "primer*.js")) + [os.path.join(WEB, "data", "magazine-issues.js")]:
